...
class ProgressChartBlockDistance extends StatefulWidget {
  const ProgressChartBlockDistance({super.key});

  @override
  State<ProgressChartBlockDistance> createState() => _ProgressChartBlockDistanceState();
}

class _ProgressChartBlockDistanceState extends State<ProgressChartBlockDistance> {
    ...
    for (int i = z - 1; i >= 0; i--) {
      ...
      bars.putIfAbsent(label, () {
        ...
        if (dayItems.isNotEmpty) {
          return dayItems.map((e) => e.distance).reduce(
